...
function matches(order: OrdersModel, term: string, pipe: PipeTransform) {
  return 
     order.user_Identifier.toLowerCase().includes(term.toLowerCase())
  || order.created_On.toLowerCase().includes(term.toLowerCase())
