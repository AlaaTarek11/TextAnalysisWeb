...
const httpFormDataOptions = {
  ...
  headers: new HttpHeaders({ 'Accept': 'Content-Type' })
...
export class restApiService {
   ...
   */
  // POST
   postDocData(   doc: FormData): Observable<any> {

   

    return this.http.post<any>(GlobalComponent.API_URL + GlobalComponent.DocumentCreate,doc, httpFormDataOptions);
  }
   ...
   */
  // POST
  postEditDocData(   doc: FormData): Observable<any> {

   

    return this.http.post<any>(GlobalComponent.API_URL + GlobalComponent.DocumentUpdate,doc, httpFormDataOptions);
  }
  ...
  */
  ...
  documentsSearch(searchData:any): Observable<any> {
    ...
    //var headerToken = {'Authorization': `Bearer `+ localStorage.getItem('token')};    
    var headerToken = {}; 
    return this.http.post(GlobalComponent.API_URL + GlobalComponent.DocumentSearch,searchData, {  headers: headerToken, responseType: 'text' });
  }

  
  documentHighlight(Data:any): Observable<any> {
    debugger
    //var headerToken = {'Authorization': `Bearer `+ localStorage.getItem('token')};    
    var headerToken = {}; 
    return this.http.post(GlobalComponent.API_URL + GlobalComponent.DocumentHighlight,Data, {  headers: headerToken, responseType: 'text' });
  }
    // Single
    getSingleDocData(id:any): Observable<any> {
      // var headerToken = {'Authorization': `Bearer `+ localStorage.getItem('token')};    
      var headerToken={}
      return this.http.get(GlobalComponent.API_URL + GlobalComponent.DocumentGetById+id, {  headers: headerToken, responseType: 'text' });
    }
